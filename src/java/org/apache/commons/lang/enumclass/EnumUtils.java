...
/**
 * <p>Utility class for accessing and manipulating {@link EnumClass}s.</p>
 *
...
public class EnumUtils {
     ...
     */
    public static EnumClass getEnum(Class enumClass, String name) {
        return EnumClass.getEnum(enumClass, name);
    }
    ...
    public static Map getEnumMap(Class enumClass) {
        return EnumClass.getEnumMap(enumClass);
    }
    ...
    public static List getEnumList(Class enumClass) {
        return EnumClass.getEnumList(enumClass);
    }
