 ...
 * @version $Id$
 */
public abstract class ValuedEnum extends EnumClass {
     ...
     */
    protected static EnumClass getEnum(Class enumClass, int value) {
        if (enumClass == null) {
            throw new IllegalArgumentException("The Enum Class must not be null");
        }
        List list = EnumClass.getEnumList(enumClass);
